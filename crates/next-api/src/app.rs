...
impl AppProject {
    ...
    async fn rsc_module_context(self: Vc<Self>) -> Result<Vc<ModuleAssetContext>> {
        Ok(ModuleAssetContext::new(
            ...
            Layer::new(rcstr!("app-rsc")).with_user_friendly_name(rcstr!("Server Component")),
        ))
    }
    ...
    async fn edge_rsc_module_context(self: Vc<Self>) -> Result<Vc<ModuleAssetContext>> {
        Ok(ModuleAssetContext::new(
            ...
            Layer::new(rcstr!("app-edge-rsc"))
                .with_user_friendly_name(rcstr!("Edge Server Component")),
        ))
    }
    ...
    async fn route_module_context(self: Vc<Self>) -> Result<Vc<ModuleAssetContext>> {
        ...
        Ok(ModuleAssetContext::new(
            ...
            Layer::new(rcstr!("app-route")).with_user_friendly_name(rcstr!("App Route")),
        ))
    }
    ...
    async fn edge_route_module_context(self: Vc<Self>) -> Result<Vc<ModuleAssetContext>> {
        ...
        Ok(ModuleAssetContext::new(
            ...
            Layer::new(rcstr!("app-edge-route")).with_user_friendly_name(rcstr!("Edge App Route")),
        ))
    }
    ...
    async fn client_module_context(self: Vc<Self>) -> Result<Vc<ModuleAssetContext>> {
        ...
        Ok(ModuleAssetContext::new(
            ...
            Layer::new(rcstr!("app-client"))
                .with_user_friendly_name(rcstr!("Client Component Browser")),
        ))
    }
    ...
    async fn ssr_module_context(self: Vc<Self>) -> Result<Vc<ModuleAssetContext>> {
        ...
        Ok(ModuleAssetContext::new(
            ...
            Layer::new(rcstr!("app-ssr")).with_user_friendly_name(rcstr!("Client Component SSR")),
        ))
    }
    ...
    async fn edge_ssr_module_context(self: Vc<Self>) -> Result<Vc<ModuleAssetContext>> {
        ...
        Ok(ModuleAssetContext::new(
            ...
            Layer::new(rcstr!("app-edge-ssr"))
                .with_user_friendly_name(rcstr!("Client Component SSR - Edge")),
        ))
    }
